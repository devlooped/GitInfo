...
//OR
//Assembly: AssemblyFileVersion (ThisAssembly.Git.BuildDate.Year + "." + ThisAssembly.Git.BuildDate.Month + "." + ThisAssembly.Git.BuildDate.Day + "." + ThisAssembly.Git.SemVer.Patch)]
